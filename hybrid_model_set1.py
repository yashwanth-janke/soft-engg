...
def generate_hybrid_data_set1(data_path, output_path):
    """
    Generate augmented dataset with binary predictions from Set 1 models:
    RandomForest, AdaBoost, GradientBoosting
    ...
    print("Training Set 1 models and generating predictions...")
    for name, model in MODEL_SET1.items():
    ...
    print(f"Augmented dataset with Set 1 binary predictions saved to {output_path}")
...
if __name__ == "__main__":
    ...
    output_path = "data/set1/pc1_fulls1.csv"
    augmented_data = generate_hybrid_data_set1(data_path, output_path)